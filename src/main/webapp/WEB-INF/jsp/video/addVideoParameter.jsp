...
<!-- 视频 -->
<script src="<%=basePath %>resources/js/business/addVideoParameter.js"></script>
    					...
    					<div class="modal-header">
      					...
      					<div style="margin-top: 20px;">
      			   			<div class="form-group">
      							<label  class="col-sm-3 control-label">视频厂商：</label> 
      						<div class="col-sm-7">
                    			<select class="form-control" id="type" name="type" onchange="typeChange();">
                    				<option>--请选择--</option>
                    				<option value="0">萤石云<optione>
                    				<option value="1">海康威视<optione>
                    			</select>
                    		</div>
              				</div>
             			</div>  
      					<div style="margin-top: 20px;" id="addip">
      			   			<div class="form-group">
      							<label  class="col-sm-3 control-label">IP地址：</label> 
      						<div class="col-sm-7">
                    			<input class="form-control" value="" name="ip"  ></input>
                    		</div>
              				</div>
             			</div>
             			<div style="margin-top: 20px;" id="addport">
      			   				<div class="form-group">
      								<label  class="col-sm-3 control-label">端口：</label>
      								<div class="col-sm-7">
                    					<input class="form-control" value="" name="port"   ></input>
                    				</div>
              					</div>
              			</div>
             			<div style="margin-top: 20px;" id="adduserName">
      			   			<div class="form-group">
      							<label  class="col-sm-3 control-label">用户名：</label>
      							<div class="col-sm-7">
                    				<input class="form-control" value="" name="userName"  ></input>
                    			</div>
              				</div>
             			</div>
             			<div style="margin-top: 20px;" id="addpassWord">
      			   			<div class="form-group">
					    		...
					    		<label class="control-label rowTxt " for="title" >密码：</label>
      							...
      							<div class="col-sm-7">
                    				<input class="form-control" value="" name="passWord"  maxlength="50px" type="password"></input>
                    			</div>
              				</div>
             			</div>
             		</div>
