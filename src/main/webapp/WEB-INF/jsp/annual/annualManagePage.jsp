...
<script src="<%=basePath %>resources/js/business/annualManagePage.js"></script>
<style type="text/css">
html, body {
	height: 100%;
	overflow: hidden;
		...
		<div id="cond" style="margin-top: 10px;">
			<form class="form-inline" role="form">
				...
				<div class="form-group" style="margin-left: 10px;">
					 报告标题: <input id="headNameId" class="form-control" style="width: 150px;margin-right: 20px;" maxlength="25"> 
					 报告年份：<input id="headYearId" name="year" class="form-control" style="width: 150px;margin-right: 20px;" >
				</div>
				<div class="form-group" style="margin-left: 10px;">
					<button type="button" class="btn btn-success" onclick="searchBtn();" ><span class="glyphicon glyphicon-search"></span>查询</button>
					<a data-toggle="modal" href="<%=basePath%>annual/toAdd.do"
					...
					<button type="button" class="btn btn-warning" onclick="updateInfo();"><span class="glyphicon glyphicon-edit"></span>修改</button>
           	 		<button type="button" class="btn btn-danger" onclick="delInfo();"><span class="glyphicon glyphicon-remove"></span>删除</button>
				</div>
			</form>
		</div>
		<!-- 增加弹框 -->
	...
	<div class="modal fade" id="myModalUpdate" tabindex="-1"
		...
		<form id="formUpdateInfo" method="post" action="" class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                	<input id="updateFileName" name="fileName" class="form-control" maxlength="250">
                </div>
              </div>
               <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                	<textarea rows="5" cols="6" id="updateResume" name="resume" style="width:418px;" maxlength="250"></textarea>
                </div>
              </div>
               <div class="form-group">
                ...
                <div class="col-sm-6">
                	<input type="text" class="form-control" id="updateRemarks" name="remarks" maxlength="250">
                	</input>
                </div>
               </div> 
                <div class="form-group">
                ...
                <div class="col-sm-6">
                	<input  name="attUrl" class="imgUrl imgUrl1" type="hidden"  value="" id="uploadFileInput">
						<!-- 记录所有附件名隐藏域 -->
		...
		<div class="modal-dialog" style="margin-left: 20%;">
			<div class="modal-content" style="width:900px;">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalSearch">年度评估详情</h4>
				</div>
				<div class="modal-body">
		<form id="formSearchInfo" method="post" action="" class="form-horizontal">
