...
<%-- <script src="<%=basePath %>resources/js/business/jquery-1.7.1.min.js"></script> --%>
<script src="<%=basePath %>resources/js/business/webVideoCtrl.js"></script>
<script src="<%=basePath %>resources/js/business/videoSystemManagerNew.js"></script>
...
<script type="text/javascript">
	...
	<script>
		document.write("<link type='text/css' href=<%=basePath%>resources/css/demo.css?version=" + new Date().getTime() + "' rel='stylesheet' />");
	</script>
</head>
<body onunload="closePage()">
<div id="divPlugin" class="plugin" style="width:1000px;height:600px;margin-left:auto;margin-right:auto;"></div>
<div class="left" style="display: none"> 
	...
	<fieldset class="login">
		<legend>登录</legend>
		<table cellpadding="0" cellspacing="3" border="0">
			<input id="channel" style="display:none" value="${videoInfo.channel} " />
			<tr>
				<td class="tt">IP地址</td>
				<td><input id="loginip" type="text" class="txt" value="${videoInfo.ip }" /></td>
				<td class="tt">端口号</td>
				<td><input id="port" type="text" class="txt" value="${videoInfo.port} " /></td>
			</tr>
			<tr>
				<td class="tt">用户名</td>
				<td><input id="username" type="text" class="txt" value="${videoInfo.userName}" /></td>
				<td class="tt">密码</td>
				<td><input id="password" type="password" class="txt" value="${videoInfo.passWord}" /></td>
			</tr>
			<tr>
				<td class="tt">设备端口</td>
				<td colspan="2"><input id="deviceport" type="text" class="txt" value="8080" />（可选参数）</td>
				<td>
					窗口分割数&nbsp;
					<select class="sel2" onchange="changeWndNum(1);">
...
<div style="width:1000px;margin-left:auto;margin-right:auto;"><!--  -->
	<div class="left">
	<fieldset class="preview" style="width:482px;height:289px;">
		<legend>预览</legend>
		<table cellpadding="0" cellspacing="3" border="0">
			<tr>
				<td class="tt">码流类型</td>
