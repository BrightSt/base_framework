...
<script src="<%=basePath%>resources/js/business/rectifyReportHbj.js"></script>
<style type="text/css">
html, body {
	height: 100%;
	overflow: hidden;
			...
			<div class="modal-content">
				...
				<form id="formupdateInfo" method="post" action=""
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea rows="6" cols="33" name='beforeState' id="editbeforeState"></textarea>
						</div>
					</div>
				   <div class="form-group">
						<div class="col-sm-4" style="text-align:center;">
						 ...
						 <div class="col-sm-5" id="editbeforeStateFileUrl">
						  	<!-- <input  id="editbeforeStateFileUrl" name="beforeStateFileUrl" class="imgUrl imgUrl1 form-control" value="" readonly="readonly"> -->
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label"><span
						...
						<div class="col-sm-5">
							<textarea id="editafterState" rows="6" cols="33" name='afterState'></textarea>
						</div>
					</div>
				   <div class="form-group">
						<div class="col-sm-4" style="text-align:center;">
						 ...
						 <div class="col-sm-5" id="editafterStateFileUrl">
						  	<!-- <input  id="editafterStateFileUrl" name="afterStateFileUrl" class="imgUrl imgUrl2 form-control" value="" readonly="readonly"> -->
						</div>
					</div>
					...
					<form id="formupdateInspectInfo" method="post" action=""
						...
						<table cellpadding="5" align="center"
							...
							<tr>
								...
								<td>
									<textarea rows="6" cols="33" name='beforeState' id='beforeStateMore'></textarea>
								</td>
							</tr>
						    ...
						    <tr>
								...
								<td>
									<textarea rows="6" cols="33" name='afterState' id="afterStateMore"></textarea>
								</td>
							</tr>
							<tr>
								<td>
				...
				<form id="formSubmitReform" method="post" action=""
					...
					<div class="form-group">
						<label class="col-sm-4 control-label"><span
							style='color: red; font-size: 20px; position: relative; top: 7px; right: 2px; margin-left: -7px;'>*</span>整改前情况</label>
						<div class="col-sm-5">
							<textarea rows="6" cols="33" name='beforeState'></textarea>
						</div>
					</div>
				   <div class="form-group">
						<div class="col-sm-4" style="text-align:center;">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label"><span
							style='color: red; font-size: 20px; position: relative; top: 7px; right: 2px; margin-left: -7px;'>*</span>整改后情况</label>
						<div class="col-sm-5">
							<textarea rows="6" cols="33" name='afterState'></textarea>
						</div>
					</div>
				   <div class="form-group">
						<div class="col-sm-4" style="text-align:center;">
