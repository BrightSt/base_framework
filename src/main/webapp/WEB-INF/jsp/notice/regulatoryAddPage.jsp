	...
	<div class="modal-body" style="overflow:scroll;height:100%;>
		...
		<aside class="side-right" id='third_side_right'>
					...
					<div class="form-group" style="margin-left: 10px;">
						...
						<select class="form-control" style="width:750px; ;" id="type">
					...
					<div class="form-group" style="margin-left: 10px;">
						...
						<input type="text" class="form-control" style="width:750px; ;" id="addTitle" placeholder='标题...' maxlength="100">
					</div>
					<!--- 输入框 --->
					<div class="form-group" style="margin-left: 10px; ;" >
				...
				<!-- <div class="form-group" style="margin-left: 10px;  ;">
					...
					<input class="form-control" type="text" id="addTitle" placeholder="请输入通知公告关键字" name="title" data-options="required:true"  style="width:750px; ;">
		...
		var rootPath = getRootPath();
			...
			function saveInfo(){
		     ...
		     //检查关键字
		  		...
		  		if(flag){
		  			$.commonReq({
		  				url : rootPath + "/regulatory/addRegs.do",
		  				async : true,
		  				data : {
		                	"body":body,
		                	"title":title,
