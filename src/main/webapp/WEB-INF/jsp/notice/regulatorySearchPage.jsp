	...
	<div class="div-a">
		...
		<form class="form-inline" role="form">
	        ...
	        <div class="form-group" style="margin-left: 10px;">
				...
				<button type="button" class="btn btn-primary" onclick="total();"><span class="glyphicon glyphicon-list-alt"></span>统计</button>
          	...
          	<input type="hidden" name="id" id="updateId"/>
       		<aside class="side-right" id='third_side_right'>
					...
					<div class="form-group" style="margin-left: 10px;">
						...
						<input type="text" class="form-control" style="width:750px;" id="updateName" placeholder='标题...'>
					</div>
					<!--- 输入框 --->
					<div class="form-group" style="margin-left: 10px;">
	...
	shi.selectpicker({
  	...
  	function searchBtn(){
  		...
  		$('#dt').bootstrapTable({
			...
			url:'<%=basePath%>regulatory/findAllSearchRegs.do',
 ...
 //修改通知公告
     ...
     /*  //检查关键字
      ...
      //附件
  		...
  		if(flag){
  			 $.commonReq({
 				url : rootPath + "/regulatory/updateRegulatory.do",
 				async : true,
 				data:{
                	"id":id,
                	"body":body,
	...
	function total(){
		debugger;
		 window.location.href="<%=basePath%>regulatory/toTotal.do";
