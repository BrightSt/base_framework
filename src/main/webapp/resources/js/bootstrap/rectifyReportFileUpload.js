			...
			success : function(data) {
				...
				if(jsonObj.result=="success"){
					...
					/*if(type=='1'){
					 ...
					 if(type=='1'){
							$(".btn_upload1").attr("src",jsonObj.imgPath+jsonObj.path);
							var beforeFile = $("#uploadFileId1").val();
							var afterFile = '';
							...
							$("#uploadFileId1").val(afterFile);
							var beforeFileName = $("#uploadFileName1").html();
							...
							$("#uploadFileName1").html(afterFileName);
						}else if(type==2){
							...
							$(".btn_upload").attr("src",jsonObj.imgPath+jsonObj.path);
							var beforeFile = $("#uploadFileId4").val();
							var afterFile = '';
							if(beforeFile==''||beforeFile=='1'){
								afterFile = jsonObj.saveFileName;
							}else{
